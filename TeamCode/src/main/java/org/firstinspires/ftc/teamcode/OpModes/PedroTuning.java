...
import static org.firstinspires.ftc.teamcode.OpModes.PedroTuning.changes;
import static org.firstinspires.ftc.teamcode.OpModes.PedroTuning.draw;
import static org.firstinspires.ftc.teamcode.OpModes.PedroTuning.drawOnlyCurrent;
import static org.firstinspires.ftc.teamcode.OpModes.PedroTuning.follower;
import static org.firstinspires.ftc.teamcode.OpModes.PedroTuning.stopRobot;
import static org.firstinspires.ftc.teamcode.OpModes.PedroTuning.telemetryM;
 ...
 * is, when paired with StrafeVelocityTuner, allows FollowerConstants.PedroPathing to create a Vector that
 ...
 * reaching the end of the distance, it averages them and prints out the velocity obtained. It is
 * recommended to run this multiple times on a full battery to get the best results. What this does
 * is, when paired with ForwardVelocityTuner, allows FollowerConstants.PedroPathing to create a Vector that
 * empirically represents the direction your mecanum wheels actually prefer to go in, allowing for
 * more accurate following.
 *
 * @author Anyi Lin - 10158 Scott's Bots
...
class ForwardZeroPowerAccelerationTuner extends OpMode {
    ...
    public void loop() {
        ...
        if (!end) {
            ...
            if (gamepad1.aWasPressed()) {
                Constants.PedroPathing.followerConstants.setForwardZeroPowerAcceleration(average);
