...
public class NearIntakeGatePathsRed extends NearIntakeGatePaths {
    ...
    private static final double GOAL_X = 138, GOAL_Y = 140;
    ...
    public NearIntakeGatePathsRed(Follower follower) {
        ...
        Intake2 = follower.pathBuilder().addPath(
                new BezierCurve(new Pose(99, 95), new Pose(74, 70), new Pose(135, 65.5))
        ).setLinearHeadingInterpolation(Math.toRadians(42), Math.toRadians(21)).build();

        Shoot3 = follower.pathBuilder().addPath(
                new BezierCurve(new Pose(135, 65.5), new Pose(81, 80), new Pose(99, 95))
        ).setLinearHeadingInterpolation(Math.toRadians(21), Math.toRadians(42)).build();

        Intake3 = follower.pathBuilder().addPath(
                new BezierCurve(new Pose(99, 95), new Pose(81, 54), new Pose(135, 65.5))
        ).setLinearHeadingInterpolation(Math.toRadians(42), Math.toRadians(21)).build();
    ...
    @Override public ShootPathBuilder.Result buildShoot3() { return shootBuilder.build(new Pose(135, 65.5), new Pose(81, 80), new Pose(99, 95)); }
    @Override public ShootPathBuilder.Result buildShoot4() { return shootBuilder.build(new Pose(135, 65.5), new Pose(81, 80), new Pose(99, 95)); }
    @Override public ShootPathBuilder.Result buildShoot5() { return shootBuilder.build(new Pose(135, 65.5), new Pose(81, 80), new Pose(99, 95)); }
    @Override public ShootPathBuilder.Result buildShoot6() { return shootBuilder.build(new Pose(126, 83), new Pose(89, 105)); }
}
