...
public class NearIntakeGatePathsBlue extends NearIntakeGatePaths {
    ...
    public NearIntakeGatePathsBlue(Follower follower) {
        ...
        Intake2 = follower.pathBuilder().addPath(
                new BezierCurve(new Pose(45, 95), new Pose(70, 70), new Pose(14, 63))
        ).setLinearHeadingInterpolation(Math.toRadians(138), Math.toRadians(160)).build();

        Shoot3 = follower.pathBuilder().addPath(
                new BezierCurve(new Pose(18.5, 64), new Pose(63, 80), new Pose(45, 95))
        ...
        Shoot4 = follower.pathBuilder().addPath(
                new BezierCurve(new Pose(18.5, 63), new Pose(63, 80), new Pose(45, 95))
        ).setLinearHeadingInterpolation(Math.toRadians(160), Math.toRadians(138)).build();
    ...
    @Override public ShootPathBuilder.Result buildShoot3() { return shootBuilder.build(new Pose(18.5, 64), new Pose(63, 80), new Pose(45, 95)); }
    @Override public ShootPathBuilder.Result buildShoot4() { return shootBuilder.build(new Pose(18.5, 63), new Pose(63, 80), new Pose(45, 95)); }
    @Override public ShootPathBuilder.Result buildShoot5() { return shootBuilder.build(new Pose(18.5, 63), new Pose(63, 80), new Pose(45, 95)); }
