...
public class FarPathsRed extends FarPaths {
    ...
    private static final double GOAL_X = 144, GOAL_Y = 143;
    ...
    public FarPathsRed(Follower follower) {
        ...
        Shoot2 = follower.pathBuilder().addPath(
                new BezierLine(new Pose(124, 33), new Pose(87, 15))
        ...
        Shoot3 = follower.pathBuilder().addPath(
                new BezierLine(new Pose(134, 10), new Pose(87, 15))
        ).setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(51)).build();
        ...
        Shoot4 = follower.pathBuilder().addPath(
                new BezierLine(new Pose(134, 23.627), new Pose(87, 15))
        ).setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(51)).build();

        Park = follower.pathBuilder().addPath(
                new BezierLine(new Pose(87, 11.951), new Pose(87, 31.364))
    ...
    @Override public ShootPathBuilder.Result buildShoot2() { return shootBuilder.build(new Pose(124, 33), new Pose(87, 12)); }
    @Override public ShootPathBuilder.Result buildShoot3() { return shootBuilder.build(new Pose(134, 10), new Pose(87, 11.951)); }
