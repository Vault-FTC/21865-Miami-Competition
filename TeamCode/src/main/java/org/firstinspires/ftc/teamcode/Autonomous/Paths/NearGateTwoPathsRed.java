...
public class NearGateTwoPathsRed extends NearGateTwoPaths {
    ...
    public NearGateTwoPathsRed(Follower follower) {
        ...
        Shoot2 = follower.pathBuilder().addPath(
                new BezierCurve(new Pose(138.051, 59.220), new Pose(113.716, 52.943), new Pose(99, 95))
        ).setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(36.5)).build();

        GateIntake1 = follower.pathBuilder().addPath(
                new BezierCurve(new Pose(99, 95), new Pose(74, 70), new Pose(135.5, 64.5))
        ).setLinearHeadingInterpolation(Math.toRadians(36.5), Math.toRadians(20)).build();

        Shoot3 = follower.pathBuilder().addPath(
                new BezierLine(new Pose(126.5, 62), new Pose(99, 95))
        ).setLinearHeadingInterpolation(Math.toRadians(20), Math.toRadians(36.5)).build();

        GateIntake2 = follower.pathBuilder().addPath(
                new BezierCurve(new Pose(99, 95), new Pose(81, 54), new Pose(135.5, 64.5))
        ).setLinearHeadingInterpolation(Math.toRadians(36.5), Math.toRadians(20)).build();

        Shoot4 = follower.pathBuilder().addPath(
                new BezierCurve(new Pose(126.5, 62), new Pose(81, 80), new Pose(99, 95))
        ).setLinearHeadingInterpolation(Math.toRadians(20), Math.toRadians(36.5)).build();

        SpikeIntake2 = follower.pathBuilder().addPath(
                new BezierCurve(new Pose(99, 95), new Pose(90.714, 27.325), new Pose(132, 38))
        ).setLinearHeadingInterpolation(Math.toRadians(36.5), Math.toRadians(0)).build();

        Shoot5 = follower.pathBuilder().addPath(
                new BezierCurve(new Pose(129, 35), new Pose(95.028, 57.951), new Pose(99, 95))
        ).setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(36.5)).build();
        ...
        Shoot6 = follower.pathBuilder().addPath(
                new BezierLine(new Pose(130.485, 83.696), new Pose(87.153, 104.725))
    ...
    @Override public ShootPathBuilder.Result buildShoot3() { return shootBuilder.build(new Pose(125.5, 62), new Pose(99, 95)); }
    @Override public ShootPathBuilder.Result buildShoot4() { return shootBuilder.build(new Pose(125.5, 62), new Pose(81, 80), new Pose(99, 95)); }
    @Override public ShootPathBuilder.Result buildShoot5() { return shootBuilder.build(new Pose(129, 35), new Pose(95.028, 57.951), new Pose(99, 95)); }
    @Override public ShootPathBuilder.Result buildShoot6() { return shootBuilder.build(new Pose(130.485, 83.696), new Pose(87.153, 104.725)); }
}
